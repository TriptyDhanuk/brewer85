...
const SaveForLater = ({ id, image, name, price, discount, quantity }) => {
  ...
  return (
    <div className="body px-4">
      <div className="fixed top-8 left-4 right-4 z-30 text-center flex flex-col items-center">
        {notification && (
          <Notification
            quantity={notification.quantity} productName={notification.name}
          />
        )}
      ...
      <div className="items-container">
        {cartItems.length > 0 ? (
          ...
          <div className="empty-cart-message">
            <Lottie options={{
              loop: true,
              autoplay: true, animationData: emptyWishlistAnimation
            }} height={300}
              width={300} />
