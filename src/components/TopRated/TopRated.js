...
const TopRated = ({ id, image, name, price, discount }) => {
  ...
  return (
    <div className="relative mx-[0.625rem]">
      <div
        className="product-card border border-solid border-slate-200 rounded-lg"
            ...
            {isMenuPage && (
              <div className="flex items-center">
                ...
                <div className="w-1/2">
                  ...
                  {existingCartItem ? (
                    <Link to="/checkout">
                      <button className="py-2 px-5 w-full font-semibold uppercase text-white border border-solid border-white rounded-md hover:text-white hover:bg-lime-600 duration-150 hover:border-lime-600 ml-2">
                        CART
                      </button>
                    </Link>
                  ) : (
